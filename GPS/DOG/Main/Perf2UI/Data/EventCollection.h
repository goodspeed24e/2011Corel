...
public:
	...
	void ClearData()
	{
		...
		m_BasicEventMap.ClearData();

		m_MessageEventMap.ClearData();
		m_VariantDataEventMap.ClearData();
		m_BufferEventMap.ClearData();

		m_VideoFrameEventMap.ClearData();

		m_AudioStreamInfoUpdateEventMap.ClearData();
		m_AudioOutputUpdateEventMap.ClearData();
		m_AudioDevCapUpdateEventMap.ClearData();
