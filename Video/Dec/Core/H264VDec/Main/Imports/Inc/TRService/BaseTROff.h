...
//++++++++++++++++++++++++++ reset switch flags ++++++++++++++++++++++++++
//Multi Threaded Region - doesnt need stub, controlled by #define
#ifdef iviTR_ENABLE_MULTI_THREADED_REGION
#undef iviTR_ENABLE_MULTI_THREADED_REGION
#endif

//Anti-debugger - doesnt need stub, controlled by #define
#ifdef iviTR_ENABLE_ANTIDEBUG
#undef iviTR_ENABLE_ANTIDEBUG
#endif

//Memory integrity checking - doesnt need stub, controlled by #define
#ifdef iviTR_ENABLE_MEMORY_INTEGRITY_CHECKING
#undef iviTR_ENABLE_MEMORY_INTEGRITY_CHECKING
#endif

//Macro name checking - doesnt need stub, controlled by #define
