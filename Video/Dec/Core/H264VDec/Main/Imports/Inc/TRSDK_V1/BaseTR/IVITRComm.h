...
#define __IVITRCOMM_H_
	...
	#include "IVITrWinDef.h"
		...
		#define LOGID_iviTR_ICEBP_CHECK									96
		#define LOGID_iviTR_SYSTEM_DEBUG_REGISTRY_CHECK					97
		#define LOGID_iviTR_VERIFY_SYSER_ENGINE							98
		#define LOGID_iviTR_VERIFY_SYSER_SYSERBOOT						99
		#define LOGID_iviTR_DETECT_PRINTEXCEPTION						100
		#define LOGID_iviTR_INT2D_CHECK									101
		#define LOGID_iviTR_SOFTICE_ICEEXT_REGISTRY_CHECK				102
		#define LOGID_iviTR_SOFTICE_ICEEXT_REGISTRY_CHECK_INV			103
