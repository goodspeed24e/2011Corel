...
#ifndef _NVSCRAMBLER_H_
#define _NVSCRAMBLER_H_
...
public:
    ...
    void GenerateKey(DWORD pKey[4]);
    void UpdateIV(DWORD pIV[4]);
    void Scramble(const BYTE* pt, BYTE* ct, const DWORD dwByteCount);
};

#endif //_NVSCRAMBLER_H_