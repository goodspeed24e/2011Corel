...
namespace XVE
{
    ...
    enum XVE_EVENT_TYPE
    {
        ...
        XVE_EVENT_FRAMERATE_CONVERSION          = 1,    //< the list of effect can do frame rate conversion.
    };
    ...
    enum XVE_SET_TYPE_MODE
    {
        XVE_SETTYPE_DEFAULT                             = 0,
        XVE_SETTYPE_TEST_ONLY                         = 1,
    };

    enum XVE_MULTIPLEOUTPUT_TYPE
    {
        XVE_MULTIPLEOUTPUT_FRAMERATE_CONVERSION     = 1 << 0,
        XVE_MULTIPLEOUTPUT_STEREO_CONVERSION        = 1 << 1,
    };
}
