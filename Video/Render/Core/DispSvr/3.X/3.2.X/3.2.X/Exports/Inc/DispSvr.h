...
#ifndef __IDisplayStereoControl_FWD_DEFINED__
#define __IDisplayStereoControl_FWD_DEFINED__
typedef interface IDisplayStereoControl IDisplayStereoControl;
#endif 	/* __IDisplayStereoControl_FWD_DEFINED__ */
...
enum DisplayServerInitFlags
	...
	DISPSVR_FORCE_DISABLE_RTV_FROM_ORIGIN	= 0x8000
    } ;
...
enum DisplayRequest
	...
	DISPLAY_REQUEST_ClearPresenterBuffer	= ( DISPLAY_REQUEST_TestCooperativeLevel + 1 ) ,
	DISPLAY_REQUEST_DWMCompositionChanged	= ( DISPLAY_REQUEST_ClearPresenterBuffer + 1 ) ,
	DISPLAY_REQUEST_VideoFormat	= ( DISPLAY_REQUEST_DWMCompositionChanged + 1 ) ,
	DISPLAY_REQUEST_ResetDevice	= ( DISPLAY_REQUEST_VideoFormat + 1 ) 
    } ;

enum DisplayCustomizdOutputExtension
    {	DISPLAY_CUSTOMIZEDOUTPUT_StereoMode	= 0x1,
	DISPLAY_CUSTOMIZEDOUTPUT_ExclusiveMode	= 0x2
    } ;
...
enum DISPSVR_DEVICE_STATUS
    {	DISPSVR_DEVICE_S_OK	= 0,
	DISPSVR_DEVICE_E_FAIL	= 0x80004005,
	DISPSVR_DEVICE_MIXER_PRESENTER_FAIL	= 0x80000000
    } ;
...
EXTERN_C const IID IID_IDisplayProperties;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE SetDispFrameRate( 
            /* [in] */ DWORD dwFrameRate) = 0;
    ...
    typedef struct IDisplayPropertiesVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *SetDispFrameRate )( 
            IDisplayProperties * This,
            /* [in] */ DWORD dwFrameRate);
...
#define IDisplayProperties_SetDispFrameRate(This,dwFrameRate)	\
    ( (This)->lpVtbl -> SetDispFrameRate(This,dwFrameRate) ) 
...
enum DispSvrEngineEvent
	...
	DISPSVR_RENDER_ENGINE_DEVICE_NEED_RESET	= ( DISPSVR_RENDER_ENGINE_DEVICE_RECOVERED + 1 ) 
    } ;
...
#ifndef __IDisplayStereoControl_INTERFACE_DEFINED__
#define __IDisplayStereoControl_INTERFACE_DEFINED__

/* interface IDisplayStereoControl */
/* [unique][helpstring][uuid][object][local] */ 


enum StereoDisplayProperties
    {	STEREO_DISPLAYPROP_NONE	= 0,
	STEREO_DISPLAYPROP_SIDEBYSIDE_LR	= ( STEREO_DISPLAYPROP_NONE + 1 ) ,
	STEREO_DISPLAYPROP_SIDEBYSIDE_RL	= ( STEREO_DISPLAYPROP_SIDEBYSIDE_LR + 1 ) ,
	STEREO_DISPLAYPROP_TOPBOTTOM_LR	= ( STEREO_DISPLAYPROP_SIDEBYSIDE_RL + 1 ) ,
	STEREO_DISPLAYPROP_TOPBOTTOM_RL	= ( STEREO_DISPLAYPROP_TOPBOTTOM_LR + 1 ) ,
	STEREO_DISPLAYPROP_AUTO	= ( STEREO_DISPLAYPROP_TOPBOTTOM_RL + 1 ) 
    } ;

EXTERN_C const IID IID_IDisplayStereoControl;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("4E1D464A-AB73-4782-94EF-57ABFFBA4237")
    IDisplayStereoControl : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE GetStereoDisplayMode( 
            /* [out] */ DWORD *dwStereoDispProp) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE SetStereoDisplayMode( 
            /* [in] */ DWORD dwStereoDispProp) = 0;
        
    };
    
#else 	/* C style interface */

    typedef struct IDisplayStereoControlVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            IDisplayStereoControl * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ 
            __RPC__deref_out  void **ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE *GetStereoDisplayMode )( 
            IDisplayStereoControl * This,
            /* [out] */ DWORD *dwStereoDispProp);
        
        HRESULT ( STDMETHODCALLTYPE *SetStereoDisplayMode )( 
            IDisplayStereoControl * This,
            /* [in] */ DWORD dwStereoDispProp);
        
        END_INTERFACE
    } IDisplayStereoControlVtbl;

    interface IDisplayStereoControl
    {
        CONST_VTBL struct IDisplayStereoControlVtbl *lpVtbl;
    };
...
#define IDisplayStereoControl_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IDisplayStereoControl_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IDisplayStereoControl_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IDisplayStereoControl_GetStereoDisplayMode(This,dwStereoDispProp)	\
    ( (This)->lpVtbl -> GetStereoDisplayMode(This,dwStereoDispProp) ) 

#define IDisplayStereoControl_SetStereoDisplayMode(This,dwStereoDispProp)	\
    ( (This)->lpVtbl -> SetStereoDisplayMode(This,dwStereoDispProp) ) 
...
#endif 	/* __IDisplayStereoControl_INTERFACE_DEFINED__ */
