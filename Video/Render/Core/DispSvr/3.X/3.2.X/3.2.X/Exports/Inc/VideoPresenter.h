...
namespace DispSvr
{
	enum PRESENTER_PROPERTY_FLAG
	{
		...
		PRESENTER_PROPERTY_DWMQUEUINGENABLED = 1 << 3,
	};
	...
	enum VIDEO_DECODE_CAP
	{
		...
		VIDEO_CAP_FRAMERATE_60  = 1 << 9,	//< video fps : 60
		VIDEO_CAP_FRAMERATE_50  = 1 << 10,	//< video fps : 50
		VIDEO_CAP_FRAMERATE_30  = 1 << 11,	//< video fps : 30
		VIDEO_CAP_FRAMERATE_25  = 1 << 12,	//< video fps : 25
		VIDEO_CAP_FRAMERATE_24  = 1 << 13,	//< video fps : 24
	};

	enum PRESENTER_INFO
	{
		PRESENTER_NONE = 0,
		PRESENTER_D3DOVERLAY = 1 << 0,
		PRESENTER_PROPRIETARYOVERLAY = 1 << 1,
		PRESENTER_D3D = 1 << 2,
		PRESENTER_FLIPEX = 1 << 3
	};
