...
HRESULT CAMDSORTVideoPresenter::CreateSORT()
{
	...
	desc.Width = GetRegistry(REG_BACKBUFFER_WIDTH, 0);
	desc.Height = GetRegistry(REG_BACKBUFFER_HEIGHT, 0);
