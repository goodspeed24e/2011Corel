...
namespace DispSvr
{
	...
	public:
		...
		typedef HRESULT (__stdcall *TpfnGetNumberOfPhysicalMonitorsFromHMONITOR)(HMONITOR hMonitor, LPDWORD pdwNumberOfPhysicalMonitors);
		...
		TpfnGetNumberOfPhysicalMonitorsFromHMONITOR pfnGetNumberOfPhysicalMonitorsFromHMONITOR;
