...
#define LogMediaType(x)
    ...
    inline void DBGMSG(PCTSTR format, ...)
    {
        va_list args;
    ...
    inline LPCWSTR GetGUIDNameConst(const GUID& guid)
    {
        ...
        IF_EQUAL_RETURN(guid, MFVideoFormat_Base); //     0x00000000 );
        ...
        IF_EQUAL_RETURN(guid, MFAudioFormat_Base); //             0x00000000 );
