...
private:
	...
	CButton m_checkboxEvr;		// control to use evr.
...
public:
	CButton m_checkboxIVIDsDemux;
	CButton m_checkboxMsDemux;
	CButton m_checkboxCLDemux;
	CButton m_checkboxIVIVideo;
	CButton m_checkboxCLVideo;
	CButton m_checkboxIVIAudio;
	CButton m_checkboxCLAudio;
	CButton m_checkboxVMR9;
	CButton m_checkboxIVIVideoDXVA;
	CButton m_checkboxVideoSourceDO;
	...
	CButton m_radioEvr;
	CButton m_radioVideoSourceDO;

	CButton m_radioDShowSync;

	enum SUBGRAPH_DEMUX UserDefDemux;
	enum SUBGRAPH_VIDEODECOER UserDefVideo;
	enum SUBGRAPH_AUDIODECODER UserDefAudio;
	enum SUBGRAPH_VIDEORENDERER UserDefVideoRender;
	enum SUBGRAPH_VIDEOMIXER UserDefVideoMixer;

public:
	afx_msg void OnBnClickedRadioIviDemux();
public:
	afx_msg void OnBnClickedRadioClDemux();
public:
	afx_msg void OnBnClickedRadioMsDemux();
public:
	afx_msg void OnBnClickedRadioIviVideo();
public:
	afx_msg void OnBnClickedRadioClVideo();
public:
	afx_msg void OnBnClickedRadioEvr();
public:
	afx_msg void OnBnClickedRadioDxva();
public:
	afx_msg void OnBnClickedRadioIviAudio();
public:
	afx_msg void OnBnClickedRadioClAudio();
public:
	afx_msg void OnBnClickedRadioIviVideo2();
public:
	afx_msg void OnBnClickedRadioIvi60fps();
public:
	afx_msg void OnBnClickedRadioVideoSourceDO();
public:
	afx_msg void OnBnClickedRadioDshowsync();
};
