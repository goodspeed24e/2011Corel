...
DEFINE_GUID(D3DAUTHENTICATEDQUERY_UNRESRICTTEDPROTECTEDSHAREDRESOURCECOUNT, 
0x12f0bd6, 0xe662, 0x4474, 0xbe, 0xfd, 0xaa, 0x53, 0xe5, 0x14, 0x3c, 0x6d);

typedef struct _D3DAUTHENTICATEDCHANNEL_QUERYUNRESRICTTEDPROTECTEDSHAREDRESOURCECOUNT_OUTPUT
{
    D3DAUTHENTICATEDCHANNEL_QUERY_OUTPUT Output;

    UINT   NumUnrestrictedProtectedSharedResources;

} D3DAUTHENTICATEDCHANNEL_QUERYUNRESRICTTEDPROTECTEDSHAREDRESOURCECOUNT_OUTPUT;
...
} D3DAUTHENTICATEDCHANNEL_QUERYROUTPUTID_OUTPUT;
...
typedef struct _D3DAUTHENTICATEDCHANNEL_QUERYINFOBUSTYPE_OUTPUT
{
    ...
    D3DBUSTYPE BusType;
    BOOL bAccessibleInContigiousBlocks;
    BOOL bAccessibleInNonContigousBlocks;
...
DEFINE_GUID(D3DAUTHETICATEDCONFIGURE_INITIALIZE, 
...
DEFINE_GUID(D3DAUTHETICATEDCONFIGURE_PROTECTION, 
...
DEFINE_GUID(D3DAUTHETICATEDCONFIGURE_CRYPTOSESSION, 
...
DEFINE_GUID(D3DAUTHETICATEDCONFIGURE_SHAREDRESOURCE, 
