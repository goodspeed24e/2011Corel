...
enum PrivateQueryID
{
	PQID_DUAL_DXVA_DECODE	= 1
};

// Query structure for Private Query Device with ID: PQID_DUAL_DXVA_DECODE
typedef struct tagPQUERY_DUAL_DXVA_DECODE
{
	int iPrivateQueryID;	// [IN] Must be PQID_DUAL_DXVA_DECODE (1)
