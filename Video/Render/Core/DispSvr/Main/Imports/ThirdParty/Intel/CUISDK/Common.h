...
#define IGFX_D3D_CUSTOM_VPSC_KEY						1
#define IGFX_D3D_CUSTOM_VPSC_ENABLED					0 //default value
#define IGFX_D3D_CUSTOM_VPSC_DISABLED					1

#define IGFX_D3D_CUSTOM_TEXTURE_QUALITY_KEY				2
...
#define IGFX_D3D_CUSTOM_ANISOTROPIC_KEY					3
...
#define IGFX_D3D_CUSTOM_VSYNC_KEY						4
