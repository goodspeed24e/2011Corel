...
//                  hNvDisplay(IN) - NVIDIA Display selection. It can be NVAPI_DEFAULT_HANDLE or a handle enumerated from NvAPI_EnumNVidiaDisplayHandle().
//                  outputId(IN)   - The display output id. If it's "0" then the default outputId from NvAPI_GetAssociatedDisplayOutputId() will be used.
...
typedef enum _NVAPI_VIDEO_STATE_COMPONENT_ID
{
    ...
    NVAPI_VIDEO_STATE_COMPONENT_DYNAMIC_CONSTRAST,  // Permits control of video's dynamic contrast value
...
typedef enum _NVAPI_VIDEO_COMPONENT_ALGORITHM
{
    ...
    VIDEO_COMP_ALGO_DEINTERLACE_SONY                 = VIDEO_COMP_ALGO_CUSTOM_BASE,  // Use Sony Deinterlacing algorithm
    ...
    VIDEO_COMP_ALGO_SCALING_ALG_SONY                 = VIDEO_COMP_ALGO_CUSTOM_BASE,  // Use Sony scaling component
    ...
    VIDEO_COMP_ALGO_NOISE_REDUCE_SONY                = VIDEO_COMP_ALGO_CUSTOM_BASE,  // Use Sony noise reduction
    VIDEO_COMP_ALGO_EDGE_ENHANCE_PUREVIDEO           = 0,  // Use PureVideo Sharpening Filter
    VIDEO_COMP_ALGO_EDGE_ENHANCE_SONY                = VIDEO_COMP_ALGO_CUSTOM_BASE,  // Use Sony Sharpening Filter
    ...
    VIDEO_COMP_ALGO_GAMUT_REMAPPING_SONY             = VIDEO_COMP_ALGO_CUSTOM_BASE, // Use Sony custom 3x3 gamut remapping matrix
...
//-----------------------------------------------------------------------------
// Private Direct3D10 APIs for Shader Debugging
//-----------------------------------------------------------------------------
...
#define NV_GPU_TOPOLOGIES_VER  MAKE_NVAPI_VERSION(NV_GPU_TOPOLOGIES,1)
...
//
//  SUPPORTED OS: Windows XP and higher
// PARAMETERS:      ptopology(OUT):  An array of *pCount topology structures.
//
// RETURN STATUS    NVAPI_OK: Call succeeded; 1 or more GPU topologies were returned
//                  NVAPI_INVALID_ARGUMENT: one or more args are invalid
//                  NVAPI_NVIDIA_DEVICE_NOT_FOUND: no NVIDIA GPU driving a display was found
...
typedef enum _NV_DPCD_REPLY_TYPE
{
    ...
    NV_DP_AUXCH_REPLYTYPE_NACK,
    NV_DP_AUXCH_REPLYTYPE_DEFER,
...
//                  to be used when custom algorithms (such as Sony MRLE) are
